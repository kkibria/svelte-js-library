...
// this return the "require" handler
function run_on_import() {
    return this_lib_require
}

const require_handler = run_on_import();

function get_exports_set_1(require, module, exports) {
    exports.getName = () => {
        return 'Jim';
    };
...
const list_of_exports = {
    1: [get_exports_set_1, {}]
}

require_handler(list_of_exports, {}, [1]);